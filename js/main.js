...
Object.entries(nav).forEach(([k,b])=>b.addEventListener('click', ()=> location.hash=k));
...
function switchView(){
  ...
  else if(h.startsWith('sitio-')){ views.detalle.classList.remove('hidden'); renderDetail(+h.split('-')[1]); }
